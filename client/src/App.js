...
import Main from './components/content/main/main.js'
  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route path="/unique"><RenderUnique descriptions = {descriptions} queriedTerm = {queriedTerm}/></Route>
        {/* <Route path="/bio"><bio_event descriptions = {descriptions} bio = {bio}/></Route> */}
      </Switch>
